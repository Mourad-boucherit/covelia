...
<StatHighlight
  value="681 EUR/an"
  label="Prime moyenne assurance auto en 2026"
...
<ExpertQuote
  quote="Le ratio combiné de l'assurance auto dépasse 100 % en 2024 : les assureurs payent plus en sinistres qu'ils ne perçoivent en primes, ce qui explique les hausses tarifaires successives."
...
<ComparisonTable
  caption="Comparatif des formules d'assurance auto"
...
Depuis 2015, l'article L.113-15-2 du Code des assurances permet de résilier son contrat d'assurance auto **à tout moment** après la première année de souscription, sans frais ni pénalités.
...
<CallToAction
  ...
  description="Utilisez un comparateur pour obtenir plusieurs devis et identifier l'offre la plus adaptée à votre profil et votre véhicule."
  links={[
