...
<StatHighlight
  value="206 EUR/an"
  label="Prime moyenne assurance habitation en 2026"
...
En 2024, les dégâts des eaux ont représenté **43,7 % des sinistres** déclarés aux assureurs, soit environ 2 millions de dossiers (source : France Assureurs). C'est le sinistre le plus fréquent en habitation, loin devant le vol ou l'incendie.
...
<ComparisonTable
  caption="Comparatif des formules d'assurance habitation"
...
<ExpertQuote
  quote="En 2024, les compagnies d'assurance ont versé 2,4 milliards d'euros d'indemnisations pour les seuls dégâts des eaux, soit 30 % du total des dédommagements en habitation. Le choix des plafonds et des franchises sur cette garantie est déterminant."
...
<CallToAction
  title="Trouvez une assurance habitation adaptée à votre logement"
