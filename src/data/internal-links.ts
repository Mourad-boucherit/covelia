...
export const articleRegistry: ArticleLink[] = [
	...
	// ── Nouveaux articles (Mars 2026 — batch 2) ──
	{
		slug: 'assurance-auto-temporaire',
		category: 'assurance-auto',
		pillar: false,
		url: '/assurance-auto/assurance-auto-temporaire/',
		title: 'Assurance auto temporaire : fonctionnement et tarifs',
		targetKeywords: ['assurance auto temporaire', 'assurance courte durée', 'assurance provisoire', '1 jour'],
		suggestedAnchors: [
			'assurance auto temporaire',
			'assurance courte durée',
			's\'assurer de 1 à 90 jours',
			'assurance provisoire auto',
		],
	},
	{
		slug: 'carte-verte-assurance-auto',
		category: 'assurance-auto',
		pillar: false,
		url: '/assurance-auto/carte-verte-assurance-auto/',
		title: 'Carte verte assurance auto : tout savoir en 2026',
		targetKeywords: ['carte verte', 'attestation assurance', 'FVA', 'mémo véhicule'],
		suggestedAnchors: [
	...
	{
		slug: 'sinistre-assurance-habitation',
		category: 'assurance-habitation',
		pillar: false,
		url: '/assurance-habitation/sinistre-assurance-habitation/',
		title: 'Sinistre assurance habitation : démarches complètes',
		targetKeywords: ['sinistre habitation', 'déclaration sinistre', 'indemnisation habitation', 'expertise sinistre'],
		suggestedAnchors: [
			'déclarer un sinistre habitation',
			'procédure de sinistre habitation',
			'indemnisation sinistre habitation',
			'expertise après sinistre',
		],
	},
	{
		slug: 'garantie-vol-assurance-habitation',
		category: 'assurance-habitation',
		pillar: false,
		url: '/assurance-habitation/garantie-vol-assurance-habitation/',
		title: 'Garantie vol assurance habitation : couverture et prix',
		targetKeywords: ['garantie vol', 'cambriolage', 'assurance habitation vol', 'indemnisation vol'],
		suggestedAnchors: [
			'garantie vol en assurance habitation',
			'couverture cambriolage',
			'indemnisation en cas de vol',
			'garantie vol habitation',
		],
	},
	{
		slug: 'mutuelle-familiale-guide',
		category: 'mutuelle-sante',
		pillar: false,
		url: '/mutuelle-sante/mutuelle-familiale-guide/',
		title: 'Mutuelle familiale : comment bien choisir en 2026',
		targetKeywords: ['mutuelle familiale', 'complémentaire santé famille', 'enfants', 'conjoint'],
		suggestedAnchors: [
			'mutuelle familiale',
			'complémentaire santé pour la famille',
			'choisir une mutuelle familiale',
			'mutuelle conjoint et enfants',
		],
	},
	{
		slug: 'mutuelle-tns-independant',
		category: 'mutuelle-sante',
		pillar: false,
		url: '/mutuelle-sante/mutuelle-tns-independant/',
		title: 'Mutuelle TNS indépendant : guide complet 2026',
		targetKeywords: ['mutuelle TNS', 'travailleur indépendant', 'loi Madelin', 'auto-entrepreneur'],
		suggestedAnchors: [
			'mutuelle TNS indépendant',
			'complémentaire santé pour indépendants',
			'loi Madelin mutuelle',
			'mutuelle travailleur non salarié',
		],
	},
	{
		slug: 'comparatif-assurance-emprunteur',
		category: 'assurance-emprunteur',
		pillar: false,
		url: '/assurance-emprunteur/comparatif-assurance-emprunteur/',
		title: 'Comparatif assurance emprunteur 2026 : critères clés',
		targetKeywords: ['comparatif assurance emprunteur', 'TAEA', 'délégation assurance', 'économies emprunteur'],
		suggestedAnchors: [
			'comparatif des assurances emprunteur',
			'comparer les assurances de prêt',
			'critères de comparaison emprunteur',
	...
	},
	{
		...
		category: 'assurance-emprunteur',
		pillar: false,
		url: '/assurance-emprunteur/assurance-emprunteur-investissement-locatif/',
		title: 'Assurance emprunteur investissement locatif : guide',
		targetKeywords: ['assurance emprunteur locatif', 'investissement locatif', 'prêt immobilier locatif', 'déduction fiscale'],
		suggestedAnchors: [
			'assurance emprunteur pour investissement locatif',
			'assurance de prêt locatif',
			'optimiser l\'assurance emprunteur locatif',
			'déduction fiscale assurance emprunteur',
		],
	},
	{
		slug: 'dda-directive-distribution-assurance',
		category: 'reglementation',
		pillar: false,
		url: '/reglementation/dda-directive-distribution-assurance/',
		title: 'DDA : directive distribution assurance en 2026',
		targetKeywords: ['DDA', 'directive distribution assurance', 'devoir de conseil', 'IPID', 'ACPR'],
		suggestedAnchors: [
			'directive distribution d\'assurance',
			'DDA en assurance',
			'obligations DDA des distributeurs',
			'IPID et document de conseil',
		],
	},
	{
		slug: 'droits-assures-guide',
		category: 'reglementation',
		pillar: false,
		url: '/reglementation/droits-assures-guide/',
		title: 'Droits des assurés en France : guide complet 2026',
		targetKeywords: ['droits des assurés', 'résiliation assurance', 'indemnisation', 'recours assurance'],
		suggestedAnchors: [
			'droits des assurés en France',
			'vos droits en tant qu\'assuré',
			'guide des droits des assurés',
			'protection des consommateurs d\'assurance',
		],
	},
];
